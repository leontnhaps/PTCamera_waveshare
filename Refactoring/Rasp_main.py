...
import config
from utils import irange, push_image

# DEFAULT_SERVER_HOST = "192.168.0.9" # 711a (주석으로 남김)
# DEFAULT_SERVER_HOST = "172.30.1.100" # 602a (주석으로 남김)

SERVER_HOST = os.getenv("SERVER_HOST", config.PI_SERVER_HOST)
CTRL_PORT = int(os.getenv("CTRL_PORT", config.AGENT_CTRL_PORT))
IMG_PORT = int(os.getenv("IMG_PORT", config.AGENT_IMG_PORT))
